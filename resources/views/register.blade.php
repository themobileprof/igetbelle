...
<head>
	<title>iGetBelle Registration</title>
	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="description" content="iGetBelle registration" />
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<div class="section_title text-success">Thank you for registering. We will contact you soon.</div>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-3 footer_col">
							<div class="footer_about">
								...
								<div class="footer_about_text">
									Have questions about pregnancy? Find answers at
									<strong>iGetBelle.com</strong>, with real doctor vetted
									facts.
								</div>
					...
					<div class="row">
						<div class="col">
							<div class="footer_bar_content d-flex flex-sm-row flex-column align-items-lg-center align-items-start justify-content-start">
								...
								, Otomatik Ventures. All rights reserved |
