...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Contact iGetBelle.com" />
    ...
    <div class="super_container">
                ...
                <div class="contact_form_container">
                  <form action="#" id="contact_form" class="contact_form">
                    ...
                    <textarea
                      ...
                      required="required"
                    ></textarea>
                    <button class="contact_button" id="contact_button">
                      send message
                    </button>
                  </form>
                </div>
              ...
              <div class="row">
                <div class="col-lg-3 offset-lg-1">
                  <div class="contact_info_list">
                    ...
                    <ul>
                      <li>
                        <span>Address: </span>Mitlton Str. 26-27 Gibraltar
                      </li>
                ...
                <div class="col-lg-4">
                  <div class="contact_info_list contact_info_list_2">
                    <ul>
                      <li>
                        <span>Address: </span>Mitlton Str. 26-27 London UK
                      </li>
                      <li><span>Email: </span>yourmail@gmail.com</li>
                      <li><span>Phone: </span>+53 345 7953 32453</li>
                    </ul>
      ...
      <footer class="footer">
        <div
          class="parallax_background parallax-window"
          data-parallax="scroll"
          data-image-src="images/footer.jpg"
          data-speed="0.8"
        ></div>
              ...
              <div class="col-lg-3 footer_col">
                <div class="footer_about">
                  ...
                  <div class="footer_about_text">
                    Lorem ipsum dolor sit amet, lorem maximus consectetur
